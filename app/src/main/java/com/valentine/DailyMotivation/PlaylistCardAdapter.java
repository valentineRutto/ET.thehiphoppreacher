...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            mTitleText = (TextView) v.findViewById(com.valentine.youtube.R.id.video_title);
            mDescriptionText = (TextView) v.findViewById(com.valentine.youtube.R.id.video_description);
            mThumbnailImage = (ImageView) v.findViewById(com.valentine.youtube.R.id.video_thumbnail);
            mShareIcon = (ImageView) v.findViewById(com.valentine.youtube.R.id.video_share);
            mShareText = (TextView) v.findViewById(com.valentine.youtube.R.id.video_share_text);
            mDurationText = (TextView) v.findViewById(com.valentine.youtube.R.id.video_dutation_text);
            mViewCountText= (TextView) v.findViewById(com.valentine.youtube.R.id.video_view_count);
            mLikeCountText = (TextView) v.findViewById(com.valentine.youtube.R.id.video_like_count);
            mDislikeCountText = (TextView) v.findViewById(com.valentine.youtube.R.id.video_dislike_count);
        }
    }
    ...
    public PlaylistCardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(com.valentine.youtube.R.layout.youtube_video_card, parent, false);
