package com.valentine.DailyMotivation;
...
import com.valentine.youtube.BuildConfig;
import com.valentine.DailyMotivation.model.Playlist;
import com.valentine.DailyMotivation.model.PlaylistItem;
import com.valentine.DailyMotivation.model.Video;
...
public class YouTubeListViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(com.valentine.youtube.R.layout.youtube_list_view_fragment, container, false);

        mListView = (ListView) rootView.findViewById(com.valentine.youtube.R.id.youtube_listview);
    ...
    protected class PlaylistAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            if (mIsLoading && position == (getCount() - 1)) {
                return mInflater.inflate(com.valentine.youtube.R.layout.youtube_video_list_item_loading, null, false);
            }
            ...
            if (convertView == null || convertView.getTag() == null) {
                ...
                convertView = mInflater.inflate(com.valentine.youtube.R.layout.youtube_video_list_item, null, false);
                viewHolder.title = (TextView) convertView.findViewById(com.valentine.youtube.R.id.video_title);
                viewHolder.description = (TextView) convertView.findViewById(com.valentine.youtube.R.id.video_description);
                viewHolder.thumbnail = (ImageView) convertView.findViewById(com.valentine.youtube.R.id.video_thumbnail);
                viewHolder.share = (ImageView) convertView.findViewById(com.valentine.youtube.R.id.video_share);
                viewHolder.shareText = (TextView) convertView.findViewById(com.valentine.youtube.R.id.video_share_text);
                viewHolder.duration = (TextView) convertView.findViewById(com.valentine.youtube.R.id.video_dutation_text);
                viewHolder.viewCount= (TextView) convertView.findViewById(com.valentine.youtube.R.id.video_view_count);
                viewHolder.likeCount = (TextView) convertView.findViewById(com.valentine.youtube.R.id.video_like_count);
                viewHolder.dislikeCount = (TextView) convertView.findViewById(com.valentine.youtube.R.id.video_dislike_count);
